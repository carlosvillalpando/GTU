...
(function(){
	...
	Main.prototype.start = function(r) {
		...
		var j = {name: 'GTU', modules:modules, div:'#content', currentLang: lang};
	...
	/**
	 * Verifica si el usuario está logeado o no
	 * @param  {Function} callback Función de retorno
	 * @return {object}            Devuelve success.true si está autenticado correctamente, false de caso contrario.
	 */
